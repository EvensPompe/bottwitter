...
var arrayCibles:string[] = await page.evaluate(() => {
    ...
    try {
      await page.$eval("#react-root > div > div > div.r-1d2f490.r-u8s1d.r-zchlnj.r-ipm5af.r-184en5c > div:nth-child(2) > div > div > div > div.css-1dbjc4n.r-1awozwy.r-18u37iz.r-1pi2tsx.r-1777fci.r-1xcajam.r-ipm5af.r-g6jmlv > div.css-1dbjc4n.r-t23y2h.r-1wbh5a2.r-kwpbio.r-rsyp9y.r-1pjcn9w.r-1279nm1.r-htvplk.r-1udh08x", (element) => {
        let btnhateful: Interbtn = element;
        btnhateful = btnhateful.children[0];
        btnhateful = btnhateful.lastChild;
        btnhateful = btnhateful.firstChild;
        btnhateful = btnhateful.firstChild;
        btnhateful = btnhateful.firstChild;
        btnhateful = btnhateful.contentWindow;
        if (btnhateful.document.getElementById("hateful-btn")) {
          // console.log(btnhateful.document.getElementById("#hateful-btn"));
          btnhateful.document.getElementById("hateful-btn").click();
        } else {
          console.log(btnhateful.document);
        }
      });
    } catch (error) {
      console.log(error);
  ...
  try {
    await page.$eval("#react-root > div > div > div.r-1d2f490.r-u8s1d.r-zchlnj.r-ipm5af.r-184en5c > div:nth-child(2) > div > div > div > div.css-1dbjc4n.r-1awozwy.r-18u37iz.r-1pi2tsx.r-1777fci.r-1xcajam.r-ipm5af.r-g6jmlv > div.css-1dbjc4n.r-t23y2h.r-1wbh5a2.r-kwpbio.r-rsyp9y.r-1pjcn9w.r-1279nm1.r-htvplk.r-1udh08x", (element) => {
      let btnMe: Interbtn = element;
      btnMe = btnMe.children[0];
      btnMe = btnMe.lastChild;
      btnMe = btnMe.firstChild;
      btnMe = btnMe.firstChild;
      btnMe = btnMe.firstChild;
      btnMe = btnMe.contentWindow;
      if (btnMe.document.getElementById("me-btn")) {
        // console.log(btnMe.document.getElementById("#me-btn"));
        btnMe.document.getElementById("me-btn").click();
      } else {
        console.log(btnMe.document);
      }
    });
  } catch (error) {
    console.log(error);
